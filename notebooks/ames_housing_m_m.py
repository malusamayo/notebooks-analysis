...
log = log + "cell[0];OUT;log;" + print_info(log) + "\n"
log = log + "cell[0];OUT;print_info;" + print_info(print_info) + "\n"
log = log + "cell[0];OUT;my_dir_path;" + print_info(my_dir_path) + "\n"

# In[2]:log = log + "cell[1];IN;log;" + print_info(log) + "\n"
log = log + "cell[1];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[1];OUT;pd;" + print_info(pd) + "\n"
log = log + "cell[1];OUT;log;" + print_info(log) + "\n"

# In[3]:log = log + "cell[2];IN;pd;" + print_info(pd) + "\n"log = log + "cell[2];IN;pd;" + print_info(pd) + "\n"
log = log + "cell[2];IN;log;" + print_info(log) + "\n"
log = log + "cell[2];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[2];OUT;df;" + print_info(df) + "\n"
log = log + "cell[2];OUT;log;" + print_info(log) + "\n"

# In[4]:log = log + "cell[3];IN;df;" + print_info(df) + "\n"log = log + "cell[3];IN;df;" + print_info(df) + "\n"
log = log + "cell[3];IN;log;" + print_info(log) + "\n"
log = log + "cell[3];IN;print_info;" + print_info(print_info) + "\n"
log = log + "cell[3];IN;c;" + print_info(c) + "\n"
log = log + "cell[3];IN;i;" + print_info(i) + "\n"
...
log = log + "cell[3];OUT;log;" + print_info(log) + "\n"
log = log + "cell[3];OUT;c;" + print_info(c) + "\n"
log = log + "cell[3];OUT;i;" + print_info(i) + "\n"
...
log = log + "cell[5];IN;log;" + print_info(log) + "\n"
log = log + "cell[5];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[5];OUT;X_test;" + print_info(X_test) + "\n"
log = log + "cell[5];OUT;log;" + print_info(log) + "\n"
log = log + "cell[5];OUT;y_train;" + print_info(y_train) + "\n"
log = log + "cell[5];OUT;y_test;" + print_info(y_test) + "\n"
log = log + "cell[5];OUT;X_train;" + print_info(X_train) + "\n"
log = log + "cell[5];OUT;X;" + print_info(X) + "\n"
...
log = log + "cell[6];IN;log;" + print_info(log) + "\n"
log = log + "cell[6];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[6];OUT;log;" + print_info(log) + "\n"
log = log + "cell[6];OUT;X_test;" + print_info(X_test) + "\n"
log = log + "cell[6];OUT;lr;" + print_info(lr) + "\n"
log = log + "cell[6];OUT;y_test;" + print_info(y_test) + "\n"
log = log + "cell[6];OUT;y_train;" + print_info(y_train) + "\n"

# In[8]:log = log + "cell[7];IN;lr;" + print_info(lr) + "\n"log = log + "cell[7];IN;X_test;" + print_info(X_test) + "\n"
log = log + "cell[7];IN;log;" + print_info(log) + "\n"
log = log + "cell[7];IN;print_info;" + print_info(print_info) + "\n"
log = log + "cell[7];IN;lr;" + print_info(lr) + "\n"
...
log = log + "cell[7];OUT;log;" + print_info(log) + "\n"
log = log + "cell[7];OUT;y_pred;" + print_info(y_pred) + "\n"
log = log + "cell[7];OUT;X_test;" + print_info(X_test) + "\n"

# In[9]:log = log + "cell[8];IN;y_pred;" + print_info(y_pred) + "\n"log = log + "cell[8];IN;y_test;" + print_info(y_test) + "\n"
log = log + "cell[8];IN;log;" + print_info(log) + "\n"
log = log + "cell[8];IN;print_info;" + print_info(print_info) + "\n"
log = log + "cell[8];IN;y_pred;" + print_info(y_pred) + "\n"
log = log + "cell[8];IN;ax;" + print_info(ax) + "\n"
...
log = log + "cell[8];OUT;y_test;" + print_info(y_test) + "\n"
log = log + "cell[8];OUT;y_pred;" + print_info(y_pred) + "\n"
log = log + "cell[8];OUT;log;" + print_info(log) + "\n"
log = log + "cell[8];OUT;plot_predictions;" + print_info(plot_predictions) + "\n"
log = log + "cell[8];OUT;plt;" + print_info(plt) + "\n"

# In[10]:log = log + "cell[9];IN;y_pred;" + print_info(y_pred) + "\n"log = log + "cell[9];IN;y_test;" + print_info(y_test) + "\n"
log = log + "cell[9];IN;y_pred;" + print_info(y_pred) + "\n"
log = log + "cell[9];IN;log;" + print_info(log) + "\n"
log = log + "cell[9];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[9];OUT;log;" + print_info(log) + "\n"
log = log + "cell[9];OUT;mean_absolute_percent_error;" + print_info(mean_absolute_percent_error) + "\n"
log = log + "cell[9];OUT;np;" + print_info(np) + "\n"

# In[11]:log = log + "cell[10];IN;X_train;" + print_info(X_train) + "\n"log = log + "cell[10];IN;X_train;" + print_info(X_train) + "\n"
log = log + "cell[10];IN;log;" + print_info(log) + "\n"
log = log + "cell[10];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[10];OUT;log;" + print_info(log) + "\n"
log = log + "cell[10];OUT;X_train;" + print_info(X_train) + "\n"

# In[12]:log = log + "cell[11];IN;df;" + print_info(df) + "\n"log = log + "cell[11];IN;df;" + print_info(df) + "\n"
log = log + "cell[11];IN;log;" + print_info(log) + "\n"
log = log + "cell[11];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[11];OUT;log;" + print_info(log) + "\n"
log = log + "cell[11];OUT;caterogical_columns;" + print_info(caterogical_columns) + "\n"

# In[13]:log = log + "cell[12];IN;df;" + print_info(df) + "\n"log = log + "cell[12];IN;df;" + print_info(df) + "\n"
log = log + "cell[12];IN;log;" + print_info(log) + "\n"
log = log + "cell[12];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[12];OUT;log;" + print_info(log) + "\n"
log = log + "cell[12];OUT;numeric_columns;" + print_info(numeric_columns) + "\n"

# In[14]:log = log + "cell[13];IN;df;" + print_info(df) + "\n"log = log + "cell[13];IN;c;" + print_info(c) + "\n"
log = log + "cell[13];IN;log;" + print_info(log) + "\n"
log = log + "cell[13];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[13];OUT;model;" + print_info(model) + "\n"
log = log + "cell[13];OUT;log;" + print_info(log) + "\n"
log = log + "cell[13];OUT;c;" + print_info(c) + "\n"
log = log + "cell[13];OUT;numeric_columns;" + print_info(numeric_columns) + "\n"
log = log + "cell[13];OUT;caterogical_columns;" + print_info(caterogical_columns) + "\n"
log = log + "cell[13];OUT;OrdinalEncoder;" + print_info(OrdinalEncoder) + "\n"
log = log + "cell[13];OUT;ColumnTransformer;" + print_info(ColumnTransformer) + "\n"
log = log + "cell[13];OUT;HistGradientBoostingRegressor;" + print_info(HistGradientBoostingRegressor) + "\n"
log = log + "cell[13];OUT;Pipeline;" + print_info(Pipeline) + "\n"
...
log = log + "cell[14];IN;log;" + print_info(log) + "\n"
log = log + "cell[14];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[14];OUT;model;" + print_info(model) + "\n"
log = log + "cell[14];OUT;log;" + print_info(log) + "\n"
log = log + "cell[14];OUT;X_train;" + print_info(X_train) + "\n"
log = log + "cell[14];OUT;y_train;" + print_info(y_train) + "\n"
...
log = log + "cell[16];IN;log;" + print_info(log) + "\n"
log = log + "cell[16];IN;print_info;" + print_info(print_info) + "\n"
log = log + "cell[16];IN;y_train;" + print_info(y_train) + "\n"
log = log + "cell[16];IN;X_train;" + print_info(X_train) + "\n"
...
log = log + "cell[16];OUT;log;" + print_info(log) + "\n"
log = log + "cell[16];OUT;model;" + print_info(model) + "\n"
log = log + "cell[16];OUT;X_train;" + print_info(X_train) + "\n"
log = log + "cell[16];OUT;y_train;" + print_info(y_train) + "\n"

# In[18]:log = log + "cell[17];IN;X_test;" + print_info(X_test) + "\n"log = log + "cell[17];IN;model;" + print_info(model) + "\n"
log = log + "cell[17];IN;log;" + print_info(log) + "\n"
log = log + "cell[17];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[17];OUT;log;" + print_info(log) + "\n"
log = log + "cell[17];OUT;model;" + print_info(model) + "\n"
log = log + "cell[17];OUT;y_test;" + print_info(y_test) + "\n"
log = log + "cell[17];OUT;X_test;" + print_info(X_test) + "\n"

# In[19]:log = log + "cell[18];IN;X_test;" + print_info(X_test) + "\n"log = log + "cell[18];IN;model;" + print_info(model) + "\n"
log = log + "cell[18];IN;log;" + print_info(log) + "\n"
log = log + "cell[18];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[18];OUT;log;" + print_info(log) + "\n"
log = log + "cell[18];OUT;model;" + print_info(model) + "\n"
log = log + "cell[18];OUT;y_test;" + print_info(y_test) + "\n"
log = log + "cell[18];OUT;X_test;" + print_info(X_test) + "\n"
log = log + "cell[18];OUT;mean_absolute_percent_error;" + print_info(mean_absolute_percent_error) + "\n"

# In[20]:log = log + "cell[19];IN;X_test;" + print_info(X_test) + "\n"log = log + "cell[19];IN;model;" + print_info(model) + "\n"
log = log + "cell[19];IN;log;" + print_info(log) + "\n"
log = log + "cell[19];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[19];OUT;y_test;" + print_info(y_test) + "\n"
log = log + "cell[19];OUT;X_test;" + print_info(X_test) + "\n"
log = log + "cell[19];OUT;model;" + print_info(model) + "\n"
log = log + "cell[19];OUT;plot_predictions;" + print_info(plot_predictions) + "\n"

# In[21]:log = log + "cell[20];IN;model;" + print_info(model) + "\n"log = log + "cell[20];IN;y_test;" + print_info(y_test) + "\n"
log = log + "cell[20];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[20];OUT;log;" + print_info(log) + "\n"
log = log + "cell[20];OUT;pi;" + print_info(pi) + "\n"
log = log + "cell[20];OUT;X_test;" + print_info(X_test) + "\n"
log = log + "cell[20];OUT;y_test;" + print_info(y_test) + "\n"

# In[22]:log = log + "cell[21];IN;pi;" + print_info(pi) + "\n"log = log + "cell[21];IN;i;" + print_info(i) + "\n"
log = log + "cell[21];IN;log;" + print_info(log) + "\n"
log = log + "cell[21];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[21];OUT;ax;" + print_info(ax) + "\n"
log = log + "cell[21];OUT;most_important_names;" + print_info(most_important_names) + "\n"
log = log + "cell[21];OUT;log;" + print_info(log) + "\n"
log = log + "cell[21];OUT;i;" + print_info(i) + "\n"
log = log + "cell[21];OUT;df;" + print_info(df) + "\n"
log = log + "cell[21];OUT;ax;" + print_info(ax) + "\n"
log = log + "cell[21];OUT;plt;" + print_info(plt) + "\n"

# In[23]:log = log + "cell[22];IN;most_important_names;" + print_info(most_important_names) + "\n"log = log + "cell[22];IN;most_important_names;" + print_info(most_important_names) + "\n"
log = log + "cell[22];IN;log;" + print_info(log) + "\n"
log = log + "cell[22];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[22];OUT;log;" + print_info(log) + "\n"
log = log + "cell[22];OUT;feature_subset;" + print_info(feature_subset) + "\n"

# In[24]:log = log + "cell[23];IN;numeric_columns;" + print_info(numeric_columns) + "\n"log = log + "cell[23];IN;df;" + print_info(df) + "\n"
log = log + "cell[23];IN;log;" + print_info(log) + "\n"
log = log + "cell[23];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[23];OUT;log;" + print_info(log) + "\n"
log = log + "cell[23];OUT;df;" + print_info(df) + "\n"
log = log + "cell[23];OUT;feature_subset;" + print_info(feature_subset) + "\n"

# In[25]:log = log + "cell[24];IN;caterogical_columns;" + print_info(caterogical_columns) + "\n"log = log + "cell[24];IN;df;" + print_info(df) + "\n"
log = log + "cell[24];IN;log;" + print_info(log) + "\n"
log = log + "cell[24];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[24];OUT;feature_subset;" + print_info(feature_subset) + "\n"
log = log + "cell[24];OUT;df;" + print_info(df) + "\n"

# In[26]:log = log + "cell[25];IN;X_train;" + print_info(X_train) + "\n"log = log + "cell[25];IN;feature_subset;" + print_info(feature_subset) + "\n"
log = log + "cell[25];IN;print_info;" + print_info(print_info) + "\n"
log = log + "cell[25];IN;X_train;" + print_info(X_train) + "\n"
...
log = log + "cell[25];OUT;log;" + print_info(log) + "\n"
log = log + "cell[25];OUT;feature_subset;" + print_info(feature_subset) + "\n"

# In[27]:log = log + "cell[26];IN;df;" + print_info(df) + "\n"log = log + "cell[26];IN;c;" + print_info(c) + "\n"
log = log + "cell[26];IN;log;" + print_info(log) + "\n"
log = log + "cell[26];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[26];IN;df;" + print_info(df) + "\n"
log = log + "cell[26];IN;X_train;" + print_info(X_train) + "\n"
...
log = log + "cell[26];OUT;reduced_model;" + print_info(reduced_model) + "\n"
log = log + "cell[26];OUT;log;" + print_info(log) + "\n"
log = log + "cell[26];OUT;feature_subset;" + print_info(feature_subset) + "\n"
log = log + "cell[26];OUT;y_train;" + print_info(y_train) + "\n"
log = log + "cell[26];OUT;caterogical_columns;" + print_info(caterogical_columns) + "\n"
log = log + "cell[26];OUT;numeric_columns;" + print_info(numeric_columns) + "\n"
log = log + "cell[26];OUT;HistGradientBoostingRegressor;" + print_info(HistGradientBoostingRegressor) + "\n"
log = log + "cell[26];OUT;c;" + print_info(c) + "\n"
log = log + "cell[26];OUT;OrdinalEncoder;" + print_info(OrdinalEncoder) + "\n"
log = log + "cell[26];OUT;ColumnTransformer;" + print_info(ColumnTransformer) + "\n"
log = log + "cell[26];OUT;Pipeline;" + print_info(Pipeline) + "\n"

# In[28]:log = log + "cell[27];IN;y_train;" + print_info(y_train) + "\n"log = log + "cell[27];IN;reduced_model;" + print_info(reduced_model) + "\n"
log = log + "cell[27];IN;log;" + print_info(log) + "\n"
log = log + "cell[27];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[27];OUT;reduced_model;" + print_info(reduced_model) + "\n"
log = log + "cell[27];OUT;log;" + print_info(log) + "\n"
log = log + "cell[27];OUT;X_train;" + print_info(X_train) + "\n"
log = log + "cell[27];OUT;feature_subset;" + print_info(feature_subset) + "\n"
log = log + "cell[27];OUT;y_train;" + print_info(y_train) + "\n"
...
log = log + "cell[29];IN;log;" + print_info(log) + "\n"
log = log + "cell[29];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[29];OUT;log;" + print_info(log) + "\n"
log = log + "cell[29];OUT;reduced_model;" + print_info(reduced_model) + "\n"
log = log + "cell[29];OUT;feature_subset;" + print_info(feature_subset) + "\n"
log = log + "cell[29];OUT;y_train;" + print_info(y_train) + "\n"
log = log + "cell[29];OUT;X_train;" + print_info(X_train) + "\n"

# In[31]:log = log + "cell[30];IN;y_test;" + print_info(y_test) + "\n"log = log + "cell[30];IN;reduced_model;" + print_info(reduced_model) + "\n"
log = log + "cell[30];IN;log;" + print_info(log) + "\n"
log = log + "cell[30];IN;print_info;" + print_info(print_info) + "\n"
log = log + "cell[30];IN;feature_subset;" + print_info(feature_subset) + "\n"
log = log + "cell[30];IN;y_test;" + print_info(y_test) + "\n"
log = log + "cell[30];IN;X_test;" + print_info(X_test) + "\n"
...
log = log + "cell[30];OUT;log;" + print_info(log) + "\n"
log = log + "cell[30];OUT;feature_subset;" + print_info(feature_subset) + "\n"
log = log + "cell[30];OUT;y_test;" + print_info(y_test) + "\n"
log = log + "cell[30];OUT;reduced_model;" + print_info(reduced_model) + "\n"

# In[32]:log = log + "cell[31];IN;reduced_model;" + print_info(reduced_model) + "\n"log = log + "cell[31];IN;X_test;" + print_info(X_test) + "\n"
log = log + "cell[31];IN;log;" + print_info(log) + "\n"
log = log + "cell[31];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[31];OUT;y_pred;" + print_info(y_pred) + "\n"
log = log + "cell[31];OUT;log;" + print_info(log) + "\n"
log = log + "cell[31];OUT;y_test;" + print_info(y_test) + "\n"
log = log + "cell[31];OUT;X_test;" + print_info(X_test) + "\n"
log = log + "cell[31];OUT;feature_subset;" + print_info(feature_subset) + "\n"
log = log + "cell[31];OUT;reduced_model;" + print_info(reduced_model) + "\n"

# In[33]:log = log + "cell[32];IN;y_test;" + print_info(y_test) + "\n"log = log + "cell[32];IN;y_pred;" + print_info(y_pred) + "\n"
log = log + "cell[32];IN;log;" + print_info(log) + "\n"
log = log + "cell[32];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[33];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[33];OUT;log;" + print_info(log) + "\n"
log = log + "cell[33];OUT;X_test;" + print_info(X_test) + "\n"
log = log + "cell[33];OUT;feature_subset;" + print_info(feature_subset) + "\n"
log = log + "cell[33];OUT;reduced_model;" + print_info(reduced_model) + "\n"
log = log + "cell[33];OUT;y_test;" + print_info(y_test) + "\n"
log = log + "cell[33];OUT;plt;" + print_info(plt) + "\n"
...
log = log + "cell[35];IN;log;" + print_info(log) + "\n"
log = log + "cell[35];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[35];OUT;X_test_encoded;" + print_info(X_test_encoded) + "\n"
log = log + "cell[35];OUT;log;" + print_info(log) + "\n"
log = log + "cell[35];OUT;shap;" + print_info(shap) + "\n"
log = log + "cell[35];OUT;shap_values;" + print_info(shap_values) + "\n"
log = log + "cell[35];OUT;explainer;" + print_info(explainer) + "\n"
log = log + "cell[35];OUT;X_test;" + print_info(X_test) + "\n"
log = log + "cell[35];OUT;feature_subset;" + print_info(feature_subset) + "\n"
log = log + "cell[35];OUT;caterogical_columns;" + print_info(caterogical_columns) + "\n"
log = log + "cell[35];OUT;numeric_columns;" + print_info(numeric_columns) + "\n"
log = log + "cell[35];OUT;pd;" + print_info(pd) + "\n"

# In[37]:log = log + "cell[36];IN;shap_values;" + print_info(shap_values) + "\n"log = log + "cell[36];IN;X_test_encoded;" + print_info(X_test_encoded) + "\n"
log = log + "cell[36];IN;log;" + print_info(log) + "\n"
log = log + "cell[36];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[36];OUT;log;" + print_info(log) + "\n"
log = log + "cell[36];OUT;shap;" + print_info(shap) + "\n"
log = log + "cell[36];OUT;X_test_encoded;" + print_info(X_test_encoded) + "\n"
log = log + "cell[36];OUT;shap_values;" + print_info(shap_values) + "\n"

# In[38]:log = log + "cell[37];IN;y_test;" + print_info(y_test) + "\n"log = log + "cell[37];IN;shap;" + print_info(shap) + "\n"
log = log + "cell[37];IN;log;" + print_info(log) + "\n"
log = log + "cell[37];IN;print_info;" + print_info(print_info) + "\n"
log = log + "cell[37];IN;X_test_encoded;" + print_info(X_test_encoded) + "\n"
log = log + "cell[37];IN;explainer;" + print_info(explainer) + "\n"
log = log + "cell[37];IN;y_test;" + print_info(y_test) + "\n"
log = log + "cell[37];IN;shap_values;" + print_info(shap_values) + "\n"
...
log = log + "cell[37];OUT;log;" + print_info(log) + "\n"

# In[39]:log = log + "cell[38];IN;plt;" + print_info(plt) + "\n"log = log + "cell[38];IN;reduced_model;" + print_info(reduced_model) + "\n"
log = log + "cell[38];IN;log;" + print_info(log) + "\n"
log = log + "cell[38];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[38];OUT;reduced_model;" + print_info(reduced_model) + "\n"
log = log + "cell[38];OUT;plot_partial_dependence;" + print_info(plot_partial_dependence) + "\n"
log = log + "cell[38];OUT;X_test;" + print_info(X_test) + "\n"
log = log + "cell[38];OUT;feature_subset;" + print_info(feature_subset) + "\n"

# In[40]:log = log + "cell[39];IN;plt;" + print_info(plt) + "\n"log = log + "cell[39];IN;reduced_model;" + print_info(reduced_model) + "\n"
log = log + "cell[39];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[39];OUT;reduced_model;" + print_info(reduced_model) + "\n"
log = log + "cell[39];OUT;plot_partial_dependence;" + print_info(plot_partial_dependence) + "\n"
log = log + "cell[39];OUT;feature_subset;" + print_info(feature_subset) + "\n"
log = log + "cell[39];OUT;X_test;" + print_info(X_test) + "\n"

# In[41]:log = log + "cell[40];IN;plt;" + print_info(plt) + "\n"log = log + "cell[40];IN;reduced_model;" + print_info(reduced_model) + "\n"
log = log + "cell[40];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[40];OUT;reduced_model;" + print_info(reduced_model) + "\n"
log = log + "cell[40];OUT;plot_partial_dependence;" + print_info(plot_partial_dependence) + "\n"
log = log + "cell[40];OUT;X;" + print_info(X) + "\n"
log = log + "cell[40];OUT;feature_subset;" + print_info(feature_subset) + "\n"

# In[42]:log = log + "cell[41];IN;plt;" + print_info(plt) + "\n"log = log + "cell[41];IN;reduced_model;" + print_info(reduced_model) + "\n"
log = log + "cell[41];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[41];OUT;log;" + print_info(log) + "\n"
...
log = log + "cell[43];IN;log;" + print_info(log) + "\n"
log = log + "cell[43];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[43];OUT;log;" + print_info(log) + "\n"
log = log + "cell[43];OUT;np;" + print_info(np) + "\n"
log = log + "cell[43];OUT;model;" + print_info(model) + "\n"
log = log + "cell[43];OUT;c;" + print_info(c) + "\n"
...
log = log + "cell[46];IN;log;" + print_info(log) + "\n"
log = log + "cell[46];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[46];OUT;log;" + print_info(log) + "\n"
log = log + "cell[46];OUT;cv_results;" + print_info(cv_results) + "\n"

# In[48]:log = log + "cell[47];IN;log;" + print_info(log) + "\n"
log = log + "cell[47];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[48];IN;print_info;" + print_info(print_info) + "\n"
log = log + "cell[48];IN;cv_results;" + print_info(cv_results) + "\n"
...
log = log + "cell[48];OUT;rename_param;" + print_info(rename_param) + "\n"

# In[73]:log = log + "cell[49];IN;cv_results;" + print_info(cv_results) + "\n"log = log + "cell[49];IN;rename_param;" + print_info(rename_param) + "\n"
log = log + "cell[49];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[49];OUT;log;" + print_info(log) + "\n"
log = log + "cell[49];OUT;rename_param;" + print_info(rename_param) + "\n"
log = log + "cell[49];OUT;np;" + print_info(np) + "\n"
log = log + "cell[49];OUT;px;" + print_info(px) + "\n"

# In[74]:log = log + "cell[50];IN;px;" + print_info(px) + "\n"log = log + "cell[50];IN;cv_results;" + print_info(cv_results) + "\n"
log = log + "cell[50];IN;log;" + print_info(log) + "\n"
log = log + "cell[50];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[50];OUT;cv_results;" + print_info(cv_results) + "\n"
log = log + "cell[50];OUT;log;" + print_info(log) + "\n"

# In[96]:log = log + "cell[51];IN;cv_results;" + print_info(cv_results) + "\n"log = log + "cell[51];IN;cv_results;" + print_info(cv_results) + "\n"
log = log + "cell[51];IN;log;" + print_info(log) + "\n"
log = log + "cell[51];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[52];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[52];OUT;log;" + print_info(log) + "\n"

# In[52]:log = log + "cell[53];IN;cv_results;" + print_info(cv_results) + "\n"log = log + "cell[53];IN;cv_results;" + print_info(cv_results) + "\n"
log = log + "cell[53];IN;log;" + print_info(log) + "\n"
log = log + "cell[53];IN;print_info;" + print_info(print_info) + "\n"
...
log = log + "cell[54];IN;print_info;" + print_info(print_info) + "\n"
log = log + "cell[54];IN;c;" + print_info(c) + "\n"
...
log = log + "cell[54];OUT;log;" + print_info(log) + "\n"

# In[ ]:log = log + "cell[55];IN;my_dir_path;" + print_info(my_dir_path) + "\n"
log = log + "cell[55];IN;log;" + print_info(log) + "\n"
...
f.write(log)
f.close()
f = open(os.path.join(my_dir_path, "ames_housing_m_m_log.txt"), "w")
f.write(log)
f.close()
