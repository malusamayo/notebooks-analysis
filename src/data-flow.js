...
exports.sameLocation = exports.RefSet = exports.SymbolType = exports.ReferenceType = exports.DataflowAnalyzer = void 0;
...
function getParameterRefs(def) {
    return new (RefSet.bind.apply(RefSet, __spreadArrays([void 0], def.params.map(function (p) { return ({
        name: p.name,
        level: ReferenceType.DEFINITION,
        type: SymbolType.VARIABLE,
        location: p.location,
